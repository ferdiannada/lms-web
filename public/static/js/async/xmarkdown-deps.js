/*! LICENSE: xmarkdown-deps.js.LICENSE.txt */
'use strict';
(globalThis.rspackChunk_lynx_js_web_rsbuild_server_middleware ||= []).push([
  [166],
  {
    5491(e, t, r) {
      r.d(t, { MarkdownIt: () => rH, createDOMPurify: () => rZ });
      var n,
        i,
        o,
        s,
      ...
      (r.r(D),
        r.d(D, {
          parseLinkDestination: () => eI,
          parseLinkLabel: () => eS,
          parseLinkTitle: () => ez,
        }));
      var b = {};
      (r.r(b), r.d(b, { default: () => tU }));
      var C = {};
      (r.r(C), r.d(C, { default: () => rj }));
      let E = {};
      function A(e, t) {
        ...
        return e.replace(/(%[a-f0-9]{2})+/gi, function (e) {
          ...
          for (let n = 0, i = e.length; n < i; n += 3) {
            ...
            if ((240 & o) == 224 && n + 6 < i) {
              let r = parseInt(e.slice(n + 4, n + 6), 16),
                i = parseInt(e.slice(n + 7, n + 9), 16);
              if ((192 & r) == 128 && (192 & i) == 128) {
                let e = ((o << 12) & 61440) | ((r << 6) & 4032) | (63 & i);
            ...
            if ((248 & o) == 240 && n + 9 < i) {
              ...
              if ((192 & r) == 128 && (192 & i) == 128 && (192 & s) == 128) {
                let e =
                  ((o << 18) & 1835008) |
                  ((r << 12) & 258048) |
                  ((i << 6) & 4032) |
      ...
      let x = {};
      function w(e, t, r) {
        ('string' != typeof t && ((r = t), (t = w.defaultChars)),
          void 0 === r && (r = !0));
        let n = (function (e) {
            let t = x[e];
            if (t) return t;
      ...
      ((S.prototype.parse = function (e, t) {
        ...
        if (
          ...
          for (let e = 0; e < R.length; e++)
            -1 !== (n = o.indexOf(R[e])) && (-1 === r || n < r) && (r = n);
          (-1 !== (t = -1 === r ? o.lastIndexOf('@') : o.lastIndexOf('@', r)) &&
            ((e = o.slice(0, t)), (o = o.slice(t + 1)), (this.auth = e)),
            (r = -1));
          for (let e = 0; e < L.length; e++)
            -1 !== (n = o.indexOf(L[e])) && (-1 === r || n < r) && (r = n);
        ...
        let a = o.indexOf('?');
        return (
          -1 !== a && ((this.search = o.substr(a)), (o = o.slice(0, a))),
          o && (this.pathname = o),
          q[r] && this.hostname && !this.pathname && (this.pathname = ''),
          this
        );
      }),
      ...
      (((i = h || (h = {}))[(i.NUM = 35)] = 'NUM'),
        ...
        ((o = p || (p = {}))[(o.VALUE_LENGTH = 49152)] = 'VALUE_LENGTH'),
        (o[(o.BRANCH_LENGTH = 16256)] = 'BRANCH_LENGTH'),
        (o[(o.JUMP_TABLE = 127)] = 'JUMP_TABLE'),
        ((s = f || (f = {}))[(s.EntityStart = 0)] = 'EntityStart'),
      ...
      class Q {
        ...
        stateNumericHex(e, t) {
          ...
          for (; t < e.length;) {
            ...
            if (
              !J(i) &&
              (!((n = i) >= h.UPPER_A) || !(n <= h.UPPER_F)) &&
              (!(n >= h.LOWER_A) || !(n <= h.LOWER_F))
            )
              return (
          ...
          for (; t < e.length; t++, this.excess++) {
            ...
            if (
              ((this.treeIndex = (function (e, t, r, n) {
                ...
                return -1;
              })(r, n, this.treeIndex + Math.max(1, i), o)),
              this.treeIndex < 0)
            )
                ...
                (this.decodeMode === d.Attribute &&
                  (0 === i ||
                    (function (e) {
                      ...
                      return (
                        e === h.EQUALS ||
                        ((t = e) >= h.UPPER_A && t <= h.UPPER_Z) ||
                        (t >= h.LOWER_A && t <= h.LOWER_Z) ||
                        J(t)
                      );
                    })(o)))
                ? 0
                : this.emitNotTerminatedNamedEntity();
            if (0 != (i = ((n = r[this.treeIndex]) & p.VALUE_LENGTH) >> 14)) {
              if (o === h.SEMI)
        ...
        emitNamedEntityData(e, t, r) {
          ...
          return (
            this.emitCodePoint(1 === t ? n[e] & ~p.VALUE_LENGTH : n[e + 1], r),
      ...
      (K(V),
        ...
        ((u = g || (g = {}))[(u.UTF8 = 0)] = 'UTF8'),
        (u[(u.ASCII = 1)] = 'ASCII'),
        (u[(u.Extensive = 2)] = 'Extensive'),
        (u[(u.Attribute = 3)] = 'Attribute'),
        (u[(u.Text = 4)] = 'Text'));
      let en = Object.prototype.hasOwnProperty;
      function ei(e, t) {
        return en.call(e, t);
      }
      function eo(e) {
      ...
      let eu = /\\([!"#$%&'()*+,\-./:;<=>?@[\\\]^_`{|}~])/g,
        ec = RegExp(
          eu.source + '|' + /&([a-z#][a-z0-9]{1,31});/gi.source,
          'gi',
        ),
        eh = /^#((?:x[a-f0-9]{1,8}|[0-9]{1,8}))$/i;
      function ep(e) {
        return 0 > e.indexOf('\\') ? e : e.replace(eu, '$1');
      }
      function ef(e) {
        return 0 > e.indexOf('\\') && 0 > e.indexOf('&')
          ? e
          : e.replace(ec, function (e, t, r) {
              if (t) return t;
              if (35 === r.charCodeAt(0) && eh.test(r)) {
                let t =
                  'x' === r[1].toLowerCase()
      ...
      function ek(e) {
        return ed.test(e) ? e.replace(em, e_) : e;
      }
      let ey = /[.?*+^$[\]\\(){}|-]/g;
      function eD(e) {
        return e.replace(ey, '\\$&');
      ...
      function ev(e) {
        let t = 0;
        for (; t < e.length && ew(e.charCodeAt(t)); t++);
        let r = e.length - 1;
        for (; r >= t && ew(e.charCodeAt(r)); r--);
        return e.slice(t, r + 1);
      }
      let eT = { mdurl: _, ucmicro: k };
      function eS(e, t, r) {
        let n,
          i,
          o,
      ...
      function eI(e, t, r) {
        ...
        if (60 === e.charCodeAt(i)) {
          for (i++; i < r && 10 !== (n = e.charCodeAt(i)) && 60 !== n;) {
            if (62 === n) {
              ((o.pos = i + 1), (o.str = ef(e.slice(t + 1, i))), (o.ok = !0));
              break;
            }
            if (92 === n && i + 1 < r) {
              i += 2;
        ...
        return (
          t === i ||
            0 !== s ||
            ((o.str = ef(e.slice(t, i))), (o.pos = i), (o.ok = !0)),
          o
        );
      }
      function ez(e, t, r, n) {
        ...
        if (n) ((s.str = n.str), (s.marker = n.marker));
          ...
          (t++, o++, 40 === n && (n = 41), (s.marker = n));
        }
        for (; o < r;) {
          if ((i = e.charCodeAt(o)) === s.marker)
            return (
              (s.pos = o + 1),
              (s.str += ef(e.slice(t, o))),
              (s.ok = !0),
              s
            );
        ...
        return ((s.can_continue = !0), (s.str += ef(e.slice(t, o))), s);
      }
      let eN = {};
      function eL() {
        this.rules = eo({}, eN);
      ...
      ((eN.code_inline = function (e, t, r, n, i) {
        let o = e[t];
        return '<code' + i.renderAttrs(o) + '>' + ek(o.content) + '</code>';
      }),
        (eN.code_block = function (e, t, r, n, i) {
          let o = e[t];
          return (
            '<pre' +
            i.renderAttrs(o) +
        ...
        (eN.fence = function (e, t, r, n, i) {
          let o,
            s = e[t],
            l = s.info ? ef(s.info).trim() : '',
            a = '',
            u = '';
          if (l) {
            let e = l.split(/(\s+)/g);
          ...
          if (
            0 ===
            (o =
              (r.highlight && r.highlight(s.content, a, u)) ||
              ek(s.content)).indexOf('<pre')
          )
            return o + '\n';
          if (l) {
            ...
            return (
              ...
              `<pre><code${i.renderAttrs({ attrs: t })}>${o}</code></pre>
`
            );
          }
...
`;
        ...
        (eN.hardbreak = function (e, t, r) {
          return r.xhtmlOut ? '<br />\n' : '<br>\n';
        }),
        (eN.softbreak = function (e, t, r) {
          return r.breaks ? (r.xhtmlOut ? '<br />\n' : '<br>\n') : '\n';
        }),
        (eN.text = function (e, t) {
          return ek(e[t].content);
        }),
        (eN.html_block = function (e, t) {
          return e[t].content;
        }),
        (eN.html_inline = function (e, t) {
          return e[t].content;
        }),
        (eL.prototype.renderAttrs = function (e) {
          let t, r, n;
          if (!e.attrs) return '';
          for (t = 0, n = '', r = e.attrs.length; t < r; t++)
            n += ' ' + ek(e.attrs[t][0]) + '="' + ek(e.attrs[t][1]) + '"';
          return n;
        }),
        (eL.prototype.renderToken = function (e, t, r) {
          let n = e[t],
            i = '';
          if (n.hidden) return '';
        ...
        (eL.prototype.renderInline = function (e, t, r) {
          let n = '',
            i = this.rules;
        ...
        (eL.prototype.renderInlineAsText = function (e, t, r) {
          let n = '';
        ...
        (eL.prototype.render = function (e, t, r) {
          let n = '',
            i = this.rules;
          for (let o = 0, s = e.length; o < s; o++) {
            let s = e[o].type;
        ...
        (eR.prototype.__find__ = function (e) {
          for (let t = 0; t < this.__rules__.length; t++)
            if (this.__rules__[t].name === e) return t;
          return -1;
        }),
        (eR.prototype.__compile__ = function () {
          let e = this,
            t = [''];
        ...
        (eR.prototype.at = function (e, t, r) {
        ...
        (eR.prototype.before = function (e, t, r, n) {
        ...
        (eR.prototype.after = function (e, t, r, n) {
          let i = this.__find__(e);
          if (-1 === i) throw Error('Parser rule not found: ' + e);
        ...
        (eR.prototype.push = function (e, t, r) {
          (this.__rules__.push({
            name: e,
            enabled: !0,
            fn: t,
        ...
        (eR.prototype.enable = function (e, t) {
          Array.isArray(e) || (e = [e]);
          let r = [];
          return (
        ...
        (eR.prototype.enableOnly = function (e, t) {
          (Array.isArray(e) || (e = [e]),
        ...
        (eR.prototype.disable = function (e, t) {
          Array.isArray(e) || (e = [e]);
          let r = [];
          return (
            e.forEach(function (e) {
              ...
              for (let i = 0, o = t.length; i < o; i++) {
                ...
                for (let l = o.length - 1; l >= 0; l--) {
                  ...
                  if ('link_close' === a.type) {
                    for (
                      l--;
                      o[l].level !== a.level && 'link_open' !== o[l].type;
                    )
                      l--;
                    continue;
                  }
                  ...
                  if (
                    ...
                    n.length > 0 &&
                      0 === n[0].index &&
                      l > 0 &&
                      'text_special' === o[l - 1].type &&
                      (n = n.slice(1));
                    for (let t = 0; t < n.length; t++) {
                      let i = n[t].url,
                        o = e.md.normalizeLink(i);
                      ...
                      if (a > c) {
                        ...
                        ((t.content = r.slice(c, a)), (t.level = u), s.push(t));
                      }
                      ...
                      ((p.content = l), (p.level = u), s.push(p));
                    ...
                    if (c < r.length) {
                      let t = new e.Token('text', '', 0);
                      ((t.content = r.slice(c)), (t.level = u), s.push(t));
                    }
                    t[i].children = o = es(o, l, s);
                  }
                }
              }
          },
                ...
                'inline' === e.tokens[t].type &&
                  ...
                  (function (e, t) {
                    ...
                    for (let o = 0; o < e.length; o++) {
                      ...
                      if (((n.length = r + 1), 'text' !== s.type)) continue;
                      let a = s.content,
                        u = 0,
                        c = a.length;
                      e: for (; u < c;) {
                        ...
                        let f = "'" === s[0],
                          d = 32;
                        if (s.index - 1 >= 0) d = a.charCodeAt(s.index - 1);
                        else
                          for (
                            r = o - 1;
                            r >= 0 &&
                            ...
                            if (e[r].content) {
                              d = e[r].content.charCodeAt(
                                e[r].content.length - 1,
                              );
                              break;
                            }
                        let m = 32;
                        if (u < c) m = a.charCodeAt(u);
                        else
                          for (
                            r = o + 1;
                            r < e.length &&
                    ...
                    Object.keys(i).forEach(function (t) {
                      e[t].content = (function (e, t) {
                        ...
                        for (let i = 0; i < t.length; i++) {
                          let o = t[i];
                          ((r += e.slice(n, o.pos) + o.ch), (n = o.pos + 1));
                        }
                        return r + e.slice(n);
                      })(e[t].content, i[t]);
                    });
      ...
      function eY() {
        this.ruler = new eR();
        for (let e = 0; e < eV.length; e++) this.ruler.push(eV[e][0], eV[e][1]);
      }
      function eX(e, t, r, n) {
        ((this.src = e),
          (this.md = t),
          ...
          (this.level = 0));
        let i = this.src;
        for (let e = 0, t = 0, r = 0, n = 0, o = i.length, s = !1; t < o; t++) {
      ...
      function eQ(e) {
        ...
        for (; n < r;)
          (124 === i &&
            (o
              ? ((l += e.substring(s, n - 1)), (s = n))
              : (t.push(l + e.substring(s, n)), (l = ''), (s = n + 1))),
            (o = 92 === i),
            n++,
            (i = e.charCodeAt(n)));
      ...
      function e0(e, t) {
        ...
        for (;;) {
          if (i >= n) return -1;
          if ((o = e.src.charCodeAt(i++)) >= 48 && o <= 57) {
            if (i - r >= 10) return -1;
            continue;
          }
          if (41 === o || 46 === o) break;
        ...
        return i < n && !eb((o = e.src.charCodeAt(i))) ? -1 : i;
      }
      ((eY.prototype.process = function (e) {
        let t = this.ruler.getRules('');
        for (let r = 0, n = t.length; r < n; r++) t[r](e);
      }),
        (eY.prototype.State = eO),
        (eX.prototype.push = function (e, t, r) {
          let n = new eM(e, t, r);
          return (
            (n.block = !0),
            r < 0 && this.level--,
        ...
        (eX.prototype.isEmpty = function (e) {
          return this.bMarks[e] + this.tShift[e] >= this.eMarks[e];
        }),
        (eX.prototype.skipEmptyLines = function (e) {
          for (
            let t = this.lineMax;
        ...
        (eX.prototype.skipSpaces = function (e) {
          for (
            let t = this.src.length;
            e < t && eb(this.src.charCodeAt(e));
            e++
          );
          return e;
        }),
        (eX.prototype.skipSpacesBack = function (e, t) {
          if (e <= t) return e;
          for (; e > t;) if (!eb(this.src.charCodeAt(--e))) return e + 1;
          return e;
        }),
        (eX.prototype.skipChars = function (e, t) {
          for (
        ...
        (eX.prototype.skipCharsBack = function (e, t, r) {
          if (e <= r) return e;
          for (; e > r;) if (t !== this.src.charCodeAt(--e)) return e + 1;
          return e;
        }),
        (eX.prototype.getLines = function (e, t, r, n) {
          if (e >= t) return '';
          let i = Array(t - e);
          for (let o = 0, s = e; s < t; s++, o++) {
            ...
            for (
              ...
              if (eb(e)) 9 === e ? (l += 4 - ((l + this.bsCount[s]) % 4)) : l++;
              else if (u - a < this.tShift[s]) l++;
              else break;
              u++;
            }
            l > r
              ? (i[o] = Array(l - r + 1).join(' ') + this.src.slice(u, e))
              : (i[o] = this.src.slice(u, e));
          }
          return i.join('');
        }),
        (eX.prototype.Token = eM));
      let e1 =
          '<[A-Za-z][A-Za-z0-9\\-]*(?:\\s+[a-zA-Z_:][a-zA-Z0-9:._-]*(?:\\s*=\\s*(?:[^"\'=<>`\\x00-\\x20]+|\'[^\']*\'|"[^"]*"))?)*\\s*\\/?>',
        e2 = '<\\/[A-Za-z][A-Za-z0-9\\-]*\\s*>',
        e3 = RegExp(
          '^(?:' +
            e1 +
            '|' +
        ...
        e4 = [
          [
            ...
            function (e, t, r, n) {
              ...
              if (s >= e.eMarks[o]) return !1;
              let l = e.src.charCodeAt(s++);
              if ((124 !== l && 45 !== l && 58 !== l) || s >= e.eMarks[o])
                return !1;
              let a = e.src.charCodeAt(s++);
              if (
                (124 !== a && 45 !== a && 58 !== a && !eb(a)) ||
                (45 === l && eb(a))
              )
                return !1;
              for (; s < e.eMarks[o];) {
                let t = e.src.charCodeAt(s);
                if (124 !== t && 45 !== t && 58 !== t && !eb(t)) return !1;
                s++;
              }
              let u = eJ(e, t + 1),
                c = u.split('|'),
              ...
              if (
                -1 === (u = eJ(e, t).trim()).indexOf('|') ||
                e.sCount[t] - e.blkIndent >= 4
              )
                return !1;
              ((c = eQ(u)).length && '' === c[0] && c.shift(),
              ...
              return (
                i && (e.push('tbody_close', 'tbody', -1), (i[1] = o)),
          ...
          [
            ...
            function (e, t, r) {
              ...
              return (
                (o.content = e.getLines(t, i, 4 + e.blkIndent, !1) + '\n'),
                (o.map = [t, e.line]),
                !0
              );
            },
          ...
          [
            ...
            function (e, t, r, n) {
              let i = e.bMarks[t] + e.tShift[t],
                o = e.eMarks[t];
              if (e.sCount[t] - e.blkIndent >= 4 || i + 3 > o) return !1;
              let s = e.src.charCodeAt(i);
              if (126 !== s && 96 !== s) return !1;
              let l = i,
                a = (i = e.skipChars(i, s)) - l;
              if (a < 3) return !1;
              let u = e.src.slice(l, i),
                c = e.src.slice(i, o);
              if (96 === s && c.indexOf(String.fromCharCode(s)) >= 0) return !1;
              if (n) return !0;
              let h = t,
                p = !1;
              for (
                ;
                !(++h >= r) &&
                (!((i = l = e.bMarks[h] + e.tShift[h]) < (o = e.eMarks[h])) ||
          ...
          [
            ...
            function (e, t, r, n) {
              ...
              for (i = t; i < r; i++) {
                ...
                if ((o = e.bMarks[i] + e.tShift[i]) >= (s = e.eMarks[i])) break;
                if (62 === e.src.charCodeAt(o++) && !t) {
                  let t,
                    r,
                    n = e.sCount[i] + 1;
                  32 === e.src.charCodeAt(o)
                    ? (o++, n++, (r = !1), (t = !0))
                    : 9 === e.src.charCodeAt(o)
                      ? ((t = !0),
                        (e.bsCount[i] + n) % 4 == 3
                          ? (o++, n++, (r = !1))
                          : (r = !0))
                      : (t = !1);
                  let l = n;
                  for (a.push(e.bMarks[i]), e.bMarks[i] = o; o < s;) {
                    let t = e.src.charCodeAt(o);
                    if (eb(t))
                      9 === t
                        ? (l += 4 - ((l + e.bsCount[i] + +!!r) % 4))
                        : l++;
                    else break;
                    o++;
                  }
          ...
          [
            ...
            function (e, t, r, n) {
              ...
              for (; o < i;) {
                let t = e.src.charCodeAt(o++);
                if (t !== s && !eb(t)) return !1;
                t === s && l++;
              }
              if (l < 3) return !1;
              if (n) return !0;
              e.line = t + 1;
              let a = e.push('hr', 'hr', 0);
              return (
                (a.map = [t, e.line]),
                (a.markup = Array(l + 1).join(String.fromCharCode(s))),
                !0
              );
            },
            ['paragraph', 'reference', 'blockquote', 'list'],
            ...
            function (e, t, r, n) {
              ...
              if (
                ...
                if (
                  ...
                  (u = Number(e.src.slice(s, c - 1))),
                  f && 1 !== u)
                )
                  return !1;
              } else {
                if (!((c = eK(e, h)) >= 0)) return !1;
                a = !1;
              }
              ...
              let g = [h, 0];
              ((l.map = g), (l.markup = String.fromCharCode(d)));
              let _ = !1,
              ...
              for (e.parentType = 'list'; h < r;) {
                ...
                let g = [h, 0];
                ((l.map = g), a && (l.info = e.src.slice(s, c - 1)));
                let y = e.tight,
                  D = e.tShift[h],
                  b = e.sCount[h],
                  C = e.listIndent;
                if (
                  ...
                  (!e.tight || _) && (p = !1),
                  (_ = e.line - h > 1 && e.isEmpty(e.line - 1)),
          ...
          [
            ...
            function (e, t, r, n) {
              let i,
                ...
                s = e.eMarks[t],
                l = t + 1;
              if (e.sCount[t] - e.blkIndent >= 4 || 91 !== e.src.charCodeAt(o))
                return !1;
              function a(t) {
                let r = e.lineMax;
                ...
                if (
                  ...
                  if (((e.parentType = i), o)) return null;
                }
                let i = e.bMarks[t] + e.tShift[t],
                  o = e.eMarks[t];
                return e.src.slice(i, o + 1);
              }
              let u = e.src.slice(o, s + 1);
              s = u.length;
              let c = -1;
              for (o = 1; o < s; o++) {
                let e = u.charCodeAt(o);
                if (91 === e) return !1;
                if (93 === e) {
                  c = o;
                  break;
                ...
                } else if (92 === e && ++o < s && 10 === u.charCodeAt(o)) {
                  let e = a(l);
                  null !== e && ((u += e), (s = u.length), l++);
                }
              }
              ...
              let h = e.md.helpers.parseLinkDestination(u, o, s);
              if (!h.ok) return !1;
              ...
              let g = e.md.helpers.parseLinkTitle(u, o, s);
              for (; g.can_continue;) {
                let t = a(l);
                if (null === t) break;
                ((u += t),
                  ...
                  (s = u.length),
                  l++,
                  (g = e.md.helpers.parseLinkTitle(u, o, s, g)));
              }
              for (
                o < s && m !== o && g.ok
                  ? ((i = g.str), (o = g.pos))
                  : ((i = ''), (o = f), (l = d));
                o < s && eb(u.charCodeAt(o));
              )
                o++;
              if (o < s && 10 !== u.charCodeAt(o) && i)
                for (i = '', o = f, l = d; o < s && eb(u.charCodeAt(o));) o++;
              if (o < s && 10 !== u.charCodeAt(o)) return !1;
              let _ = ex(u.slice(1, c));
              return (
                !!_ &&
                (!!n ||
                  (void 0 === e.env.references && (e.env.references = {}),
                  void 0 === e.env.references[_] &&
                    (e.env.references[_] = { title: i, href: p }),
                  (e.line = l),
                  !0))
              );
            },
          ...
          [
            ...
            function (e, t, r, n) {
              ...
              if (
                ...
                return !1;
              let s = e.src.slice(i, o),
                l = 0;
              for (; l < e5.length && !e5[l][0].test(s); l++);
              if (l === e5.length) return !1;
              if (n) return e5[l][2];
              let a = t + 1,
                u = e5[l][1].test('');
              if (!e5[l][1].test(s)) {
                for (
                  ;
                  a < r &&
                  (!(e.sCount[a] < e.blkIndent) || (!u && e.isEmpty(a)));
                  a++
                )
                  if (
              ...
              return (
                (c.map = [t, a]),
                (c.content = e.getLines(t, a, e.blkIndent, !0)),
                !0
              );
            },
            ['paragraph', 'reference', 'blockquote'],
          ...
          [
            ...
            function (e, t, r, n) {
              ...
              let l = 1;
              for (s = e.src.charCodeAt(++i); 35 === s && i < o && l <= 6;)
                (l++, (s = e.src.charCodeAt(++i)));
              if (l > 6 || (i < o && !eb(s))) return !1;
              if (n) return !0;
              o = e.skipSpacesBack(o, i);
              let a = e.skipCharsBack(o, 35, i);
              (a > i && eb(e.src.charCodeAt(a - 1)) && (o = a),
                (e.line = t + 1));
              let u = e.push('heading_open', 'h' + String(l), 1);
              ((u.markup = '########'.slice(0, l)), (u.map = [t, e.line]));
              let c = e.push('inline', '', 0);
              return (
                (c.content = ev(e.src.slice(i, o))),
                (c.map = [t, e.line]),
                (c.children = []),
                (e.push('heading_close', 'h' + String(l), -1).markup =
                  '########'.slice(0, l)),
                !0
              );
            },
          ...
          [
            ...
            function (e, t, r) {
              ...
              if (!s) return ((e.parentType = o), !1);
              let a = ev(e.getLines(t, l, e.blkIndent, !1));
              e.line = l + 1;
              let u = e.push('heading_open', 'h' + String(s), 1);
              ((u.markup = String.fromCharCode(n)), (u.map = [t, e.line]));
              let c = e.push('inline', '', 0);
              return (
                (c.content = a),
                (c.map = [t, e.line - 1]),
                (c.children = []),
                (e.push('heading_close', 'h' + String(s), -1).markup =
          ...
          [
            ...
            function (e, t, r) {
              ...
              let s = ev(e.getLines(t, o, e.blkIndent, !1));
              ((e.line = o),
      ...
      ((e9.prototype.tokenize = function (e, t, r) {
        ...
        for (
          ...
          ((e.tight = !l),
            ...
            (s = e.line) < r && e.isEmpty(s) && ((l = !0), (e.line = ++s)));
        }
      }),
        (e9.prototype.parse = function (e, t, r, n) {
          if (!e) return;
          let i = new this.State(e, t, r, n);
          this.tokenize(i, i.line, i.lineMax);
        }),
        (e9.prototype.State = eX),
        (e8.prototype.pushPending = function () {
          let e = new eM('text', '', 0);
          return (
        ...
        (e8.prototype.push = function (e, t, r) {
        ...
        (e8.prototype.scanDelims = function (e, t) {
          let r,
            n = this.posMax,
            i = this.src.charCodeAt(e);
          if (0 === e) r = 32;
          else if (1 === e)
            (63488 & (r = this.src.charCodeAt(0))) == 55296 && (r = 65533);
          else if ((64512 & (r = this.src.charCodeAt(e - 1))) == 56320) {
            let t = this.src.charCodeAt(e - 2);
            r =
              (64512 & t) == 55296
                ? 65536 + ((t - 55296) << 10) + (r - 56320)
                : 65533;
          ...
          if ((64512 & l) == 55296) {
            let e = this.src.charCodeAt(o + 1);
            l =
              (64512 & e) == 56320
                ? 65536 + ((l - 55296) << 10) + (e - 56320)
                : 65533;
        ...
        (e8.prototype.Token = eM));
      let e7 = /(?:^|[^a-z0-9.+-])([a-z][a-z0-9.+-]*)$/i,
        te = [];
      for (let e = 0; e < 256; e++) te.push(0);
      function tt(e, t) {
        let r,
          n = [],
          i = t.length;
        for (let o = 0; o < i; o++) {
          ...
          (((r = e.tokens[i.token]).type = 's_open'),
            ...
            (r.markup = '~~'),
            (r.content = ''),
            ((r = e.tokens[s.token]).type = 's_close'),
            (r.tag = 's'),
            (r.nesting = -1),
            (r.markup = '~~'),
            (r.content = ''),
        ...
        for (; n.length;) {
          ...
          t !== --i &&
            ((r = e.tokens[i]), (e.tokens[i] = e.tokens[t]), (e.tokens[t] = r));
        }
      }
      ...
      function tr(e, t) {
        ...
        for (let n = r - 1; n >= 0; n--) {
          ...
          let i = t[r.end],
            ...
            l = e.tokens[r.token];
          ((l.type = o ? 'strong_open' : 'em_open'),
            (l.tag = o ? 'strong' : 'em'),
            (l.nesting = 1),
            (l.markup = o ? s + s : s),
            (l.content = ''));
          let a = e.tokens[i.token];
          ((a.type = o ? 'strong_close' : 'em_close'),
            (a.tag = o ? 'strong' : 'em'),
            (a.nesting = -1),
            (a.markup = o ? s + s : s),
            (a.content = ''),
      ...
      let tn =
        ...
        ti = /^([a-zA-Z][a-zA-Z0-9+.-]{1,31}):([^<>\x00-\x20]*)$/,
        to = /^&#((?:x[a-f0-9]{1,6}|[0-9]{1,7}));/i,
        ts = /^&([a-z][a-z0-9]{1,31});/i;
      function tl(e) {
        let t = {},
          r = e.length;
        if (!r) return;
        ...
        for (let s = 0; s < r; s++) {
          ...
          if (
            (o.push(0),
            (e[n].marker !== r.marker || i !== r.token - 1) && (n = s),
            (i = r.token),
            (r.length = r.length || 0),
            !r.close)
          )
          ...
          for (; a > l; a -= o[a] + 1) {
            ...
            if (t.marker === r.marker && t.open && t.end < 0) {
              ...
              if (
                ...
                let n = a > 0 && !e[a - 1].open ? o[a - 1] + 1 : 0;
                ((o[s] = s - a + n),
                  (o[a] = n),
                  (r.open = !1),
                  (t.end = s),
          ...
          -1 !== u && (t[r.marker][3 * !!r.open + ((r.length || 0) % 3)] = u);
        }
      }
      let ta = [
          [
          ...
          [
            ...
            function (e, t) {
              ...
              if (
                ...
                return !1;
              let n = e.pending.match(e7);
              if (!n) return !1;
              let i = n[1],
                o = e.md.linkify.matchAtStart(e.src.slice(r - i.length));
              if (!o) return !1;
              let s = o.url;
          ...
          [
            ...
            function (e, t) {
              ...
              for (r++; r < i && eb(e.src.charCodeAt(r));) r++;
              return ((e.pos = r), !0);
            },
          ],
          [
            ...
            function (e, t) {
              ...
              if (i >= 55296 && i <= 56319 && r + 1 < n) {
                ...
                t >= 56320 && t <= 57343 && ((o += e.src[r + 1]), r++);
              }
              let s = '\\' + o;
              if (!t) {
                let t = e.push('text_special', '', 0);
                (i < 256 && 0 !== te[i] ? (t.content = o) : (t.content = s),
                  (t.markup = s),
                  (t.info = 'escape'));
              }
              return ((e.pos = r + 1), !0);
          ...
          [
            ...
            function (e, t) {
              ...
              n++;
              let o = e.posMax;
              for (; n < o && 96 === e.src.charCodeAt(n);) n++;
              let s = e.src.slice(i, n),
                l = s.length;
              if (e.backticksScanned && (e.backticks[l] || 0) <= i)
                return (t || (e.pending += s), (e.pos += l), !0);
              let a = n;
              for (; -1 !== (r = e.src.indexOf('`', a));) {
                for (a = r + 1; a < o && 96 === e.src.charCodeAt(a);) a++;
                let i = a - r;
                if (i === l) {
                  if (!t) {
          ...
          [
            ...
            function (e, t) {
              ...
              if (d < h && 40 === e.src.charCodeAt(d)) {
                for (
                  u = !1, d++;
                  d < h && (eb((r = e.src.charCodeAt(d))) || 10 === r);
                  d++
                );
                if (d >= h) return !1;
                if (
                  ((a = d),
                  (i = e.md.helpers.parseLinkDestination(e.src, d, e.posMax))
                    .ok)
                ) {
                  for (
                    s = e.md.normalizeLink(i.str),
                      e.md.validateLink(s) ? (d = i.pos) : (s = ''),
                      a = d;
                    d < h && (eb((r = e.src.charCodeAt(d))) || 10 === r);
                    d++
                  );
          ...
          [
            ...
            function (e, t) {
              ...
              if (d < 0) return !1;
              if ((o = d + 1) < p && 40 === e.src.charCodeAt(o)) {
                for (
                  o++;
                  o < p && (eb((r = e.src.charCodeAt(o))) || 10 === r);
                  o++
                );
                if (o >= p) return !1;
                for (
                  u = o,
                    (l = e.md.helpers.parseLinkDestination(e.src, o, e.posMax))
                      .ok &&
                      ((c = e.md.normalizeLink(l.str)),
                      e.md.validateLink(c) ? (o = l.pos) : (c = '')),
                    u = o;
                  o < p && (eb((r = e.src.charCodeAt(o))) || 10 === r);
                  o++
                );
                if (
                  ((l = e.md.helpers.parseLinkTitle(e.src, o, e.posMax)),
                  o < p && u !== o && l.ok)
                )
                  for (
                    a = l.str, o = l.pos;
                ...
                if (o >= p || 41 !== e.src.charCodeAt(o))
                  return ((e.pos = h), !1);
                o++;
              } else {
                if (void 0 === e.env.references) return !1;
                if (
                  (o < p && 91 === e.src.charCodeAt(o)
                    ? ((u = o + 1),
                      (o = e.md.helpers.parseLinkLabel(e, o)) >= 0
                        ? (i = e.src.slice(u, o++))
                        : (o = d + 1))
                    : (o = d + 1),
                  i || (i = e.src.slice(f, d)),
                  !(s = e.env.references[ex(i)]))
                )
                  return ((e.pos = h), !1);
                ((c = s.href), (a = s.title));
              }
          ...
          [
            ...
            function (e, t) {
              ...
              let o = e.src.slice(n + 1, r);
              if (ti.test(o)) {
                let r = e.md.normalizeLink(o);
              ...
              if (tn.test(o)) {
                let r = e.md.normalizeLink('mailto:' + o);
                if (!e.md.validateLink(r)) return !1;
                if (!t) {
                  let t = e.push('link_open', 'a', 1);
                  ((t.attrs = [['href', r]]),
          ...
          [
            ...
            function (e, t) {
              ...
              if (35 === e.src.charCodeAt(r + 1)) {
                ...
                let n = e.src.slice(r).match(ts);
                if (n) {
                  let r = ee(n[0], d.Strict);
                  if (r !== n[0]) {
                    if (!t) {
                      let t = e.push('text_special', '', 0);
        ...
        tu = [
          [
            ...
            function (e) {
              ...
              tl(e.delimiters);
              for (let e = 0; e < r; e++)
                t[e] && t[e].delimiters && tl(t[e].delimiters);
            },
          ],
          [
            'strikethrough',
            function (e) {
              ...
              tt(e, e.delimiters);
              for (let n = 0; n < r; n++)
                t[n] && t[n].delimiters && tt(e, t[n].delimiters);
            },
          ],
          [
            'emphasis',
            function (e) {
              ...
              tr(e, e.delimiters);
              for (let n = 0; n < r; n++)
                t[n] && t[n].delimiters && tr(e, t[n].delimiters);
            },
          ],
          [
            'fragments_join',
      ...
      function tf(e) {
        return '[object Function]' === tp(e);
      }
      function td(e) {
        return e.replace(/[.?*+^$[\]\\(){}|-]/g, '\\$&');
      }
      ((tc.prototype.skipToken = function (e) {
        let t = e.pos,
        ...
        if (e.level < i) {
          for (let i = 0; i < n; i++)
            if ((e.level++, (s = r[i](e, !0)), e.level--, s)) {
              if (t >= e.pos)
        ...
        (tc.prototype.tokenize = function (e) {
          let t = this.ruler.getRules(''),
            r = t.length,
            n = e.posMax,
            i = e.md.options.maxNesting;
        ...
        (tc.prototype.parse = function (e, t, r, n) {
          let i = new this.State(e, t, r, n);
          this.tokenize(i);
          let o = this.ruler2.getRules(''),
            s = o.length;
          for (let e = 0; e < s; e++) o[e](i);
        }),
        (tc.prototype.State = e8));
      let tm = { fuzzyLink: !0, fuzzyEmail: !0, fuzzyIP: !1 },
        tg = {
          'http:': {
            ...
            validate: function (e, t, r) {
              ...
              return (r.re.no_http ||
                (r.re.no_http = RegExp(
                  '^' +
                    r.re.src_auth +
                    `(?:localhost|(?:(?:${r.re.src_domain})\\.)+${r.re.src_domain_root})` +
                    r.re.src_port +
      ...
      function ty(e) {
        ...
        let r,
          ...
          i =
            ...
            (n = '[><｜]'),
            (r.src_pseudo_letter = `(?:(?!${n}|${r.src_ZPCc})${r.src_Any})`),
            (r.src_ip4 =
              '(?:(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.){3}(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)'),
            (r.src_auth = `(?:(?:(?!${r.src_ZCc}|[@/\\[\\]()]).){1,50}@)?`),
            (r.src_port =
              '(?::(?:6(?:[0-4]\\d{3}|5(?:[0-4]\\d{2}|5(?:[0-2]\\d|3[0-5])))|[1-5]?\\d{1,4}))?'),
            (r.src_host_terminator = `(?=$|${n}|${r.src_ZPCc})(?!${t['---'] ? '-(?!--)|' : '-|'}_|:\\d|\\.-|\\.(?!$|${r.src_ZPCc}))`),
            (r.src_path =
              `(?:[/?#](?:(?!${r.src_ZCc}|${n}|[()[\\]{}.,"'?!\\-;]).|\\[(?:(?!${r.src_ZCc}|\\]).)*\\]|\\((?:(?!${r.src_ZCc}|[)]).)*\\)|\\{(?:(?!${r.src_ZCc}|[}]).)*\\}|\\"(?:(?!${r.src_ZCc}|["]).)+\\"|\\'(?:(?!${r.src_ZCc}|[']).)+\\'|\\'(?=${r.src_pseudo_letter}|[-])|\\.{2,}[a-zA-Z0-9%/&]|\\.(?!${r.src_ZCc}|[.]|$)|` +
              (t['---'] ? '\\-(?!--(?:[^-]|$))(?:-*)|' : '\\-+|') +
              `,(?!${r.src_ZCc}|$)|` +
              `;(?!${r.src_ZCc}|$)|` +
              `\\!+(?!${r.src_ZCc}|[!]|$)|` +
            ...
            (r.src_domain =
              ...
              `(?:${r.src_pseudo_letter})` +
              '|' +
              `(?:${r.src_pseudo_letter}(?:-|${r.src_pseudo_letter}){0,61}${r.src_pseudo_letter})` +
              ')'),
            ...
            (r.tpl_email_fuzzy = `(^|${n}|"|\\(|${r.src_ZCc})(${r.src_email_name}@${r.tpl_host_fuzzy_strict})`),
        ...
        (e.onCompile(),
          ...
          o.push(i.src_xn),
          (i.src_tlds = o.join('|')),
          (i.email_fuzzy = RegExp(s(i.tpl_email_fuzzy), 'i')),
          (i.email_fuzzy_global = RegExp(s(i.tpl_email_fuzzy), 'ig')),
          (i.link_fuzzy = RegExp(s(i.tpl_link_fuzzy), 'i')),
          (i.link_fuzzy_global = RegExp(s(i.tpl_link_fuzzy), 'ig')),
          (i.link_no_ip_fuzzy = RegExp(s(i.tpl_link_no_ip_fuzzy), 'i')),
          (i.link_no_ip_fuzzy_global = RegExp(s(i.tpl_link_no_ip_fuzzy), 'ig')),
          (i.host_fuzzy_test = RegExp(s(i.tpl_host_fuzzy_test), 'i')));
        let l = [];
        function a(e, t) {
        ...
        ((e.__compiled__ = {}),
          Object.keys(e.__schemas__).forEach(function (t) {
            ...
            if (((e.__compiled__[t] = n), '[object Object]' === tp(r))) {
              if ('[object RegExp]' === tp(r.validate)) {
                var i;
                ((i = r.validate),
              ...
              } else tf(r.validate) ? (n.validate = r.validate) : a(t, r);
              tf(r.normalize)
            ...
            '[object String]' === tp(r) ? l.push(t) : a(t, r);
          }),
          ...
          (e.__compiled__[''] = { validate: null, normalize: tk() }));
      ...
      function tb(e, t) {
        if (!(this instanceof tb)) return new tb(e, t);
        (!t &&
          Object.keys(e || {}).reduce(function (e, t) {
            return e || tm.hasOwnProperty(t);
          }, !1) &&
          ((t = e), (e = {})),
          (this.__opts__ = th({}, tm, t)),
          (this.__schemas__ = th({}, tg, e)),
          (this.__compiled__ = {}),
          (this.__tlds__ = t_),
      ...
      ((tb.prototype.add = function (e, t) {
        return ((this.__schemas__[e] = t), ty(this), this);
      }),
        (tb.prototype.set = function (e) {
          return ((this.__opts__ = th(this.__opts__, e)), this);
        }),
        (tb.prototype.test = function (e) {
          let t, r;
          if (!e.length) return !1;
          if (this.re.schema_test.test(e)) {
            for (
              (r = this.re.schema_search).lastIndex = 0;
              null !== (t = r.exec(e));
            )
        ...
        (tb.prototype.pretest = function (e) {
          return this.re.pretest.test(e);
        }),
        (tb.prototype.testSchemaAt = function (e, t, r) {
          return this.__compiled__[t.toLowerCase()]
            ? this.__compiled__[t.toLowerCase()].validate(e, r, this)
            : 0;
        }),
        (tb.prototype.match = function (e) {
          let t,
            r,
            n,
            i = [],
          ...
          if (this.re.schema_test.test(e))
            for (
              (n = this.re.schema_search).lastIndex = 0;
              null !== (t = n.exec(e));
            )
          ...
          if (this.__opts__.fuzzyEmail && this.__compiled__['mailto:'])
            for (
              (n = this.re.email_fuzzy_global).lastIndex = 0;
              null !== (t = n.exec(e));
            )
              l.push({
                schema: 'mailto:',
          ...
          let u = [0, 0, 0],
            c = 0;
          for (;;) {
            let t = [o[u[0]], l[u[1]], s[u[2]]],
              r = a(a(t[0], t[1]), t[2]);
            if (!r) break;
            if (
              (r === t[0] ? u[0]++ : r === t[1] ? u[1]++ : u[2]++, r.index < c)
            )
              continue;
            let n = new tD(e, r.schema, r.index, r.lastIndex);
            (this.__compiled__[n.schema].normalize(n, this),
              i.push(n),
              (c = r.lastIndex));
          }
          return i.length ? i : null;
        }),
        (tb.prototype.matchAtStart = function (e) {
          if (!e.length) return null;
        ...
        (tb.prototype.normalize = function (e) {
          (e.schema || (e.url = `http://${e.url}`),
            'mailto:' !== e.schema ||
              /^mailto:/i.test(e.url) ||
              (e.url = `mailto:${e.url}`));
        }),
        (tb.prototype.onCompile = function () {}));
      let tC = /^xn--/,
        tE = /[^\0-\x7F]/,
        tA = /[\x2E\u3002\uFF0E\uFF61]/g,
        tF = {
      ...
      let tS = function (e, t) {
        ...
        tI = function (e, t, r) {
          let n = 0;
          for (e = r ? tx(e / 700) : e >> 1, e += tx(e / t); e > 455; n += 36)
            e = tx(e / 35);
          return tx(n + (36 * e) / (e + 38));
        },
        tz = function (e) {
          let t = [],
            r = e.length,
          ...
          s < 0 && (s = 0);
          for (let r = 0; r < s; ++r)
            (e.charCodeAt(r) >= 128 && tv('not-basic'),
              t.push(e.charCodeAt(r)));
          for (let a = s > 0 ? s + 1 : 0; a < r;) {
            let s = n;
            for (let t = 1, i = 36; ; i += 36) {
              var l;
              a >= r && tv('invalid-input');
              let s =
                (l = e.charCodeAt(a++)) >= 48 && l < 58
                  ? 26 + (l - 48)
                  : l >= 65 && l < 91
                    ? l - 65
                    : l >= 97 && l < 123
                      ? l - 97
                      : 36;
              (s >= 36 && tv('invalid-input'),
                s > tx((0x7fffffff - n) / t) && tv('overflow'),
                (n += s * t));
              let u = i <= o ? 1 : i >= o + 26 ? 26 : i - o;
              if (s < u) break;
              let c = 36 - u;
              (t > tx(0x7fffffff / c) && tv('overflow'), (t *= c));
            }
            let u = t.length + 1;
            ((o = tI(n - s, u, 0 == s)),
              tx(n / u) > 0x7fffffff - i && tv('overflow'),
              (i += tx(n / u)),
              (n %= u),
              t.splice(n++, 0, i));
          }
        ...
        tN = function (e) {
          let t = [],
            ...
            i = 0,
            o = 72;
          for (let r of e) r < 128 && t.push(tw(r));
          let s = t.length,
            l = s;
          for (s && t.push('-'); l < r;) {
            let r = 0x7fffffff;
            ...
            let a = l + 1;
            for (let u of (r - n > tx((0x7fffffff - i) / a) && tv('overflow'),
            (i += (r - n) * a),
            (n = r),
            e))
              if ((u < n && ++i > 0x7fffffff && tv('overflow'), u === n)) {
                let e = i;
                for (let r = 36; ; r += 36) {
                  ...
                  let i = e - n,
                    s = 36 - n;
                  (t.push(tw(tS(n + (i % s), 0))), (e = tx(i / s)));
                }
                (t.push(tw(tS(e, 0))), (o = tI(i, a, l === s)), (i = 0), ++l);
              }
            (++i, ++n);
          }
          return t.join('');
        ...
        tR = /^(vbscript|javascript|file|data):/,
        tM = /^data:image\/(gif|png|jpeg|webp);/;
      function tO(e) {
        let t = e.trim().toLowerCase();
        return !tR.test(t) || tM.test(t);
      }
      let tB = ['http:', 'https:', 'mailto:'];
      function tq(e) {
        let t = P(e, !0);
        if (t.hostname && (!t.protocol || tB.indexOf(t.protocol) >= 0))
          try {
            var r;
            ((r = t.hostname),
              (t.hostname = tT(r, function (e) {
                return tE.test(e) ? 'xn--' + tN(e) : e;
              })));
          } catch (e) {}
        return v(T(t));
      }
      function tP(e) {
        ...
        if (t.hostname && (!t.protocol || tB.indexOf(t.protocol) >= 0))
          try {
            ...
            ((r = t.hostname),
              (t.hostname = tT(r, function (e) {
                return tC.test(e) ? tz(e.slice(4).toLowerCase()) : e;
              })));
          } catch (e) {}
        return F(T(t), F.defaultChars + '%');
      }
      function t$(e, t) {
        if (!(this instanceof t$)) return new t$(e, t);
        (t || er(e) || ((t = e || {}), (e = 'default')),
          (this.inline = new tc()),
          (this.block = new e9()),
          (this.core = new eY()),
          (this.renderer = new eL()),
          (this.linkify = new tb()),
          (this.validateLink = tO),
          (this.normalizeLink = tq),
          (this.normalizeLinkText = tP),
          (this.utils = y),
          (this.helpers = eo({}, D)),
          (this.options = {}),
          this.configure(e),
      ...
      ((t$.prototype.set = function (e) {
        ...
        (t$.prototype.enable = function (e, t) {
          ...
          if (n.length && !t)
            throw Error('MarkdownIt. Failed to enable unknown rule(s): ' + n);
          return this;
        }),
        (t$.prototype.disable = function (e, t) {
          ...
          if (n.length && !t)
            throw Error('MarkdownIt. Failed to disable unknown rule(s): ' + n);
          return this;
        }),
      ...
      let tH = Object.entries,
        tZ = Object.setPrototypeOf,
        tG = Object.isFrozen,
      ...
      let t1 = rh(Array.prototype.forEach),
        t2 = rh(Array.prototype.lastIndexOf),
        t3 = rh(Array.prototype.pop),
        t6 = rh(Array.prototype.push),
        t5 = rh(Array.prototype.splice),
        t4 = Array.isArray,
        t9 = rh(String.prototype.toLowerCase),
        t8 = rh(String.prototype.toString),
        t7 = rh(String.prototype.match),
        re = rh(String.prototype.replace),
        rt = rh(String.prototype.indexOf),
        rr = rh(String.prototype.trim),
        rn = rh(Number.prototype.toString),
        ri = rh(Boolean.prototype.toString),
        ro = 'u' < typeof BigInt ? null : rh(BigInt.prototype.toString),
        rs = 'u' < typeof Symbol ? null : rh(Symbol.prototype.toString),
        rl = rh(Object.prototype.hasOwnProperty),
        ra = rh(Object.prototype.toString),
        ru = rh(RegExp.prototype.test),
        rc =
          ((n = TypeError),
          function () {
      ...
      function rp(e, t) {
        let r =
          arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : t9;
        if ((tZ && tZ(e, null), !t4(t))) return e;
        let n = t.length;
        for (; n--;) {
          let i = t[n];
          if ('string' == typeof i) {
      ...
      function rf(e) {
        ...
        for (let n of tH(e)) {
          var r =
            ...
            (function (e) {
              if (e) {
                if ('string' == typeof e) return tj(e, 2);
          ...
          rl(e, i) &&
            (t4(o)
              ? (t[i] = (function (e) {
                  for (let t = 0; t < e.length; t++) rl(e, t) || (e[t] = null);
                  return e;
                })(o))
      ...
      function rd(e, t) {
        for (; null !== e;) {
          let r = tV(e, t);
          if (r) {
            if (r.get) return rh(r.get);
            if ('function' == typeof r.value) return rh(r.value);
          }
          e = tW(e);
        }
        return function () {
      ...
      let rm = tY([
        ...
        rz = tX(/^(?:\w+script|data):/i),
        rN = tX(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),
        rL = tX(/^html$/i),
        rR = tX(/^[a-z][.\w]*(-[.\w]+)+$/i),
        rM = tX(/<[/\w!]/g),
        rO = tX(/<[/\w]/g),
        rB = tX(/<\/no(script|embed|frames)/i),
        rq = tX(/\/>/i),
        rP = function (e, t) {
        ...
        rU = function (e, t, r, n) {
          return rl(e, t) && t4(e[t])
            ? rp(n.base ? rf(n.base) : {}, e[t], n.transform)
            : r;
        };
      var rj = (function e() {
        let t,
        ...
        let o = n.document,
          ...
          l = s.currentScript;
        n.DocumentFragment;
        let a = n.HTMLTemplateElement,
          u = n.Node,
          c = n.Element,
          h = n.NodeFilter;
        (void 0 === n.NamedNodeMap && (n.NamedNodeMap || n.MozNamedAttrMap),
          n.HTMLFormElement);
        let p = n.DOMParser,
          f = n.trustedTypes,
          d = c.prototype,
          ...
          D = rd(d, 'shadowRoot'),
          b = rd(d, 'attributes'),
          C = u && u.prototype ? rd(u.prototype, 'nodeType') : null,
          E = u && u.prototype ? rd(u.prototype, 'nodeName') : null;
        ...
        let A = '',
          ...
          S = o,
          I = S.implementation,
          z = S.createNodeIterator,
          N = S.createDocumentFragment,
          L = S.getElementsByTagName,
          R = s.importNode,
          M = r$();
        i.isSupported =
          'function' == typeof tH &&
        ...
        let O = rI,
          ...
          ed = null,
          em = rp({}, ['audio', 'video', 'img', 'source', 'image', 'track']),
          eg = null,
          e_ = rp({}, [
            'alt',
            'class',
          ...
          eD = 'http://www.w3.org/1999/xhtml',
          eb = eD,
          eC = !1,
          eE = null,
          eA = rp({}, [ek, ey, eD], t8),
          eF = tY(['mi', 'mo', 'mn', 'ms', 'mtext']),
          ex = rp({}, eF),
          ew = tY(['annotation-xml']),
          ev = rp({}, ew),
          eT = rp({}, ['title', 'style', 'font', 'a', 'script']),
          eS = null,
          eI = ['application/xhtml+xml', 'text/html'],
          ez = null,
          eN = null,
          eL = o.createElement('form'),
          eR = function (e) {
          ...
          eM = function () {
            ...
            ((e && 'object' == typeof e) || (e = {}),
              ...
              (ez =
                ...
                (eS =
                  -1 === eI.indexOf(e.PARSER_MEDIA_TYPE)
                    ? 'text/html'
                    : e.PARSER_MEDIA_TYPE)
                  ? t8
                  : t9),
              (B = rU(e, 'ALLOWED_TAGS', q, { transform: ez })),
              (P = rU(e, 'ALLOWED_ATTR', $, { transform: ez })),
              (eE = rU(e, 'ALLOWED_NAMESPACES', eA, { transform: t8 })),
              (eg = rU(e, 'ADD_URI_SAFE_ATTR', e_, {
                transform: ez,
                base: e_,
              })),
              (ed = rU(e, 'ADD_DATA_URI_TAGS', em, {
                transform: ez,
                base: em,
              })),
              (ep = rU(e, 'FORBID_CONTENTS', ef, { transform: ez })),
              (j = rU(e, 'FORBID_TAGS', rf({}), { transform: ez })),
              (H = rU(e, 'FORBID_ATTR', rf({}), { transform: ez })),
              (eh =
                !!rl(e, 'USE_PROFILES') &&
              ...
              (eo = e.RETURN_TRUSTED_TYPE || !1),
              (er = e.FORCE_BODY || !1),
              (es = !1 !== e.SANITIZE_DOM),
              (el = e.SANITIZE_NAMED_PROPS || !1),
              (eu = !1 !== e.KEEP_CONTENT),
              (ec = e.IN_PLACE || !1),
              (O = !(function (e) {
                try {
                ...
                ? rI
                : e.ALLOWED_URI_REGEXP),
              (eb = 'string' == typeof e.NAMESPACE ? e.NAMESPACE : eD),
              (ex =
                rl(e, 'MATHML_TEXT_INTEGRATION_POINTS') &&
                e.MATHML_TEXT_INTEGRATION_POINTS &&
                'object' == typeof e.MATHML_TEXT_INTEGRATION_POINTS
                  ? rf(e.MATHML_TEXT_INTEGRATION_POINTS)
                  : rp({}, eF)),
              (ev =
                rl(e, 'HTML_INTEGRATION_POINTS') &&
                e.HTML_INTEGRATION_POINTS &&
                'object' == typeof e.HTML_INTEGRATION_POINTS
                  ? rf(e.HTML_INTEGRATION_POINTS)
                  : rp({}, ew)));
            let n =
              rl(e, 'CUSTOM_ELEMENT_HANDLING') &&
              e.CUSTOM_ELEMENT_HANDLING &&
              'object' == typeof e.CUSTOM_ELEMENT_HANDLING
                ? rf(e.CUSTOM_ELEMENT_HANDLING)
                : tJ(null);
            if (
              ((U = tJ(null)),
              rl(n, 'tagNameCheck') &&
                eR(n.tagNameCheck) &&
                (U.tagNameCheck = n.tagNameCheck),
              rl(n, 'attributeNameCheck') &&
                eR(n.attributeNameCheck) &&
                (U.attributeNameCheck = n.attributeNameCheck),
              rl(n, 'allowCustomizedBuiltInElements') &&
                'boolean' == typeof n.allowCustomizedBuiltInElements &&
              ...
              eh &&
                ((B = rp({}, rb)),
                (P = tJ(null)),
                !0 === eh.html && (rp(B, rm), rp(P, rC)),
                !0 === eh.svg && (rp(B, rg), rp(P, rE), rp(P, rF)),
                !0 === eh.svgFilters && (rp(B, r_), rp(P, rE), rp(P, rF)),
                !0 === eh.mathMl && (rp(B, ry), rp(P, rA), rp(P, rF))),
              (Z.tagCheck = null),
              (Z.attributeCheck = null),
              rl(e, 'ADD_TAGS') &&
                ('function' == typeof e.ADD_TAGS
                  ? (Z.tagCheck = e.ADD_TAGS)
                  : t4(e.ADD_TAGS) &&
                    (B === q && (B = rf(B)), rp(B, e.ADD_TAGS, ez))),
              rl(e, 'ADD_ATTR') &&
                ('function' == typeof e.ADD_ATTR
                  ? (Z.attributeCheck = e.ADD_ATTR)
                  : t4(e.ADD_ATTR) &&
                    (P === $ && (P = rf(P)), rp(P, e.ADD_ATTR, ez))),
              rl(e, 'ADD_URI_SAFE_ATTR') &&
                t4(e.ADD_URI_SAFE_ATTR) &&
                rp(eg, e.ADD_URI_SAFE_ATTR, ez),
              rl(e, 'FORBID_CONTENTS') &&
                t4(e.FORBID_CONTENTS) &&
                (ep === ef && (ep = rf(ep)), rp(ep, e.FORBID_CONTENTS, ez)),
              rl(e, 'ADD_FORBID_CONTENTS') &&
                t4(e.ADD_FORBID_CONTENTS) &&
                (ep === ef && (ep = rf(ep)), rp(ep, e.ADD_FORBID_CONTENTS, ez)),
              eu && (B['#text'] = !0),
              Q && rp(B, ['html', 'head', 'body']),
              B.table && (rp(B, ['tbody']), delete j.tbody),
              ...
              null === e.TRUSTED_TYPES_POLICY
                ? ((t = void 0), (A = ''))
                : (void 0 === t && (F || ((r = rP(f, l)), (F = !0)), (t = r)),
                  t && 'string' == typeof A && (A = v('')));
            (tY && tY(e), (eN = e));
          },
          eO = rp({}, [...rg, ...r_, ...rk]),
          eB = rp({}, [...ry, ...rD]),
          eq = function (e) {
            var t, r, n;
            let i = y(e);
            (i && i.tagName) || (i = { namespaceURI: eb, tagName: 'template' });
            let o = t9(e.tagName),
              s = t9(i.tagName);
            return (
              !!eE[e.namespaceURI] &&
                ...
                : e.namespaceURI === ek
                  ? (r = i).namespaceURI === eD
                    ...
                    : r.namespaceURI === ey
                      ...
                      : !!eB[o]
                  : e.namespaceURI === eD
                    ? ((n = i).namespaceURI !== ey || !!ev[s]) &&
                      (n.namespaceURI !== ek || !!ex[s]) &&
                      !eB[o] &&
                      (eT[o] || !eO[o])
                    : 'application/xhtml+xml' === eS && !!eE[e.namespaceURI])
            );
          },
          eP = function (e) {
            t6(i.removed, { element: e });
            try {
              y(e).removeChild(e);
            } catch (t) {
              if ((g(e), !y(e)))
          ...
          eU = function (e, t) {
            try {
              t6(i.removed, { attribute: t.getAttributeNode(e), from: t });
            } catch (e) {
              t6(i.removed, { attribute: null, from: t });
            }
          ...
          eZ = function (e) {
            ...
            for (; t.length > 0;) {
              ...
              if (1 === r) {
                let t = ez(E ? E(e) : e.nodeName);
                try {
                  (e.hasAttribute &&
                    e.hasAttribute('patchsrc') &&
                    e.removeAttribute('patchsrc'),
                    e.hasAttribute &&
                      e.hasAttribute('for') &&
                      'label' !== t &&
                      'output' !== t &&
          ...
          eG = function (e) {
            ...
            if (eb === eD)
              try {
                r = new p().parseFromString(i, eS);
              } catch (e) {}
            if (!r || !r.documentElement) {
              r = I.createDocument(eb, 'template', null);
              try {
                r.documentElement.innerHTML = eC ? A : i;
              } catch (e) {}
            }
            let s = r.body || r.documentElement;
            return (e &&
              n &&
              s.insertBefore(o.createTextNode(n), s.childNodes[0] || null),
            eb === eD)
              ? L.call(r, Q ? 'html' : 'body')[0]
              : Q
                ? r.documentElement
                : s;
          },
          ...
          eY = function (e) {
            ...
            let r = z.call(
              ...
              n = r.nextNode();
            for (; n;) ((n.data = eV(n.data)), (n = r.nextNode()));
            let i =
              null == (t = e.querySelectorAll) ? void 0 : t.call(e, 'template');
            i &&
              t1(i, (e) => {
                eJ(e.content) && eY(e.content);
              });
          },
          eX = function (e) {
            let t = E ? E(e) : null;
          ...
          eJ = function (e) {
            if (!C || 'object' != typeof e || null === e) return !1;
            try {
              return 11 === C(e);
            } catch (e) {
              return !1;
        ...
        let e0 = function (e, t) {
            if (
              !j[t] &&
              e6(t) &&
              ((U.tagNameCheck instanceof RegExp && ru(U.tagNameCheck, t)) ||
                (U.tagNameCheck instanceof Function && U.tagNameCheck(t)))
            )
              return !1;
            if (eu && !ep[t]) {
              let t = y(e),
              ...
              if (r && t) {
                let n = r.length;
                for (let i = n - 1; i >= 0; --i) {
                  let n = ec ? r[i] : m(r[i], !0);
                  t.insertBefore(n, _(e));
                }
              }
            }
            return (eP(e), !0);
          ...
          e1 = function (e, t) {
            if (
              (eK(M.beforeSanitizeElements, e, null), e !== t && null === y(e))
            )
              return !0;
            if (eX(e)) return (eP(e), !0);
            let r = ez(E ? E(e) : e.nodeName);
            if (
              (eK(M.uponSanitizeElement, e, { tagName: r, allowedTags: B }),
              e !== t && null === y(e))
            )
              return !0;
            if (
              ...
              (J &&
                ...
                eQ(e.firstElementChild)) ||
              7 === e.nodeType ||
              (J && 8 === e.nodeType && ru(rO, e.data))
            )
              return (eP(e), !0);
            if (
              j[r] ||
              (!(Z.tagCheck instanceof Function && Z.tagCheck(r)) && !B[r])
            ) {
              let t = e0(e, r);
              return (!1 === t && eK(M.afterSanitizeElements, e, null), t);
            }
            if (
              ((C ? C(e) : e.nodeType) === 1 && !eq(e)) ||
              (('noscript' === r || 'noembed' === r || 'noframes' === r) &&
                ru(rB, e.innerHTML))
            )
              return (eP(e), !0);
            if (X && 3 === e.nodeType) {
              let t = eV(e.textContent);
              e.textContent !== t &&
                (t6(i.removed, { element: e.cloneNode() }),
                (e.textContent = t));
            }
            return (eK(M.afterSanitizeElements, e, null), !1);
          },
          e2 = function (e, t, r) {
            if (
              H[t] ||
              (J && 'patchsrc' === t) ||
              (J && 'for' === t && 'label' !== e && 'output' !== e) ||
              (es && ('id' === t || 'name' === t) && (r in o || r in eL))
            )
              return !1;
            let n =
              P[t] ||
              (Z.attributeCheck instanceof Function && Z.attributeCheck(t, e));
            if (W && ru(rT, t));
            else if (G && ru(rS, t));
            else if (n) {
              if (eg[t]);
              else if (ru(O, re(r, rN, '')));
              else if (
              ...
              else if (V && !ru(rz, re(r, rN, '')));
              else if (r) return !1;
            } else if (!(
              (e6(e) &&
                ((U.tagNameCheck instanceof RegExp && ru(U.tagNameCheck, e)) ||
                  (U.tagNameCheck instanceof Function && U.tagNameCheck(e))) &&
                ((U.attributeNameCheck instanceof RegExp &&
                  ru(U.attributeNameCheck, t)) ||
                  (U.attributeNameCheck instanceof Function &&
                    U.attributeNameCheck(t, e)))) ||
              ('is' === t &&
                U.allowCustomizedBuiltInElements &&
                ((U.tagNameCheck instanceof RegExp && ru(U.tagNameCheck, r)) ||
                  (U.tagNameCheck instanceof Function && U.tagNameCheck(r))))
            ))
              return !1;
            return !0;
          },
          ...
          e4 = function (e, t, r, n) {
            try {
              (r ? e.setAttributeNS(r, t, n) : e.setAttribute(t, n),
                eX(e) ? eP(e) : t3(i.removed));
            } catch (r) {
              eU(t, e);
            }
          },
          e9 = function (e) {
            eK(M.beforeSanitizeAttributes, e, null);
            let t = e.attributes;
            if (!t || eX(e)) return;
            let r = {
                attrName: '',
            ...
            for (; n--;) {
              ...
              if (
                ...
                eK(M.uponSanitizeAttribute, e, r),
                (c = r.attrValue),
                el &&
                  ('id' === u || 'name' === u) &&
                  0 !== rt(c, ea) &&
              ...
              if (!r.forceKeepAttr) {
                ...
                (c = e5(i, u, l, c)) !== a && e4(e, s, l, c);
              }
            }
            eK(M.afterSanitizeAttributes, e, null);
          },
          e8 = function (e) {
            let t = null,
              r = eW(e);
            for (eK(M.beforeSanitizeShadowDOM, e, null); (t = r.nextNode());)
              if (
                (eK(M.uponSanitizeShadowNode, t, null),
                e1(t, e),
                e9(t),
                eJ(t.content) && e8(t.content),
                (C ? C(t) : t.nodeType) === 1)
              ) {
                let e = D(t);
                eJ(e) && (e7(e), e8(e));
              }
            eK(M.afterSanitizeShadowDOM, e, null);
          },
          e7 = function (e) {
            ...
            for (; t.length > 0;) {
              ...
              if (n) {
                let e = E ? E(r) : null;
                if ('string' == typeof e && 'template' === ez(e)) {
                  let e = r.content;
                  eJ(e) && t.push({ node: e, shadow: null });
                }
              }
              if (n) {
                let e = D(r);
        ...
        return (
          (i.sanitize = function (e) {
                ...
                'string' !=
                  typeof (e = (function (e) {
                    switch (typeof e) {
                      ...
                      case 'function':
                      case 'object': {
                        if (null === e) return ra(e);
                        let t = rd(e, 'toString');
                        if ('function' == typeof t) {
                          let r = t(e);
                          return 'string' == typeof r ? r : ra(r);
                        }
                        return ra(e);
                      }
                    }
            ...
            (K ? ((B = ee), (P = et)) : eM(r),
              (M.uponSanitizeElement.length > 0 ||
                M.uponSanitizeAttribute.length > 0) &&
                (B = rf(B)),
              M.uponSanitizeAttribute.length > 0 && (P = rf(P)),
              (i.removed = []));
            let u = ec && 'string' != typeof e && eQ(e);
            if (u) {
              eZ(e);
              ...
              if (eX(e))
                throw (
                  e$(e),
                  rc('root node is clobbered and cannot be sanitized in-place')
                );
              try {
                e7(e);
              } catch (t) {
              ...
              ((1 ===
                (o = (n = eG('\x3c!----\x3e')).ownerDocument.importNode(e, !0))
                  .nodeType &&
                'BODY' === o.nodeName) ||
              'HTML' === o.nodeName
                ? (n = o)
              ...
              if (!en && !X && !Q && -1 === e.indexOf('<'))
                return t && eo ? v(e) : e;
              if (!(n = eG(e))) return en ? null : eo ? A : '';
            }
            n && er && eP(n.firstChild);
            let c = u ? e : n,
              h = eW(c);
            try {
              for (; (l = h.nextNode());)
                (e1(l, c), e9(l), eJ(l.content) && e8(l.content));
            } catch (t) {
              throw (
                u &&
                  (e$(e),
                  t1(i.removed, (e) => {
                    e.element && eH(e.element);
                  })),
                t
              );
            }
            ...
            if (en) {
              if ((X && eY(n), ei))
                for (a = N.call(n.ownerDocument); n.firstChild;)
                  a.appendChild(n.firstChild);
              else a = n;
              return (
                (P.shadowroot || P.shadowrootmode) && (a = R.call(s, a, !0)),
                a
              );
            }
            let p = Q ? n.outerHTML : n.innerHTML;
            return (
              Q &&
                B['!doctype'] &&
                n.ownerDocument &&
                ...
                ru(rL, n.ownerDocument.doctype.name) &&
                (p = '<!DOCTYPE ' + n.ownerDocument.doctype.name + '>\n' + p),
              X && (p = eV(p)),
              t && eo ? v(p) : p
            );
          }),
          ...
          (i.isValidAttribute = function (e, t, r) {
            return (eN || eM({}), e2(ez(e), ez(t), r));
          }),
          (i.addHook = function (e, t) {
            'function' != typeof t || (rl(M, e) && t6(M[e], t));
          }),
          (i.removeHook = function (e, t) {
            if (rl(M, e)) {
              if (void 0 !== t) {
                let r = t2(M[e], t);
                return -1 === r ? void 0 : t5(M[e], r, 1)[0];
              }
              return t3(M[e]);
            }
          }),
